...
// fetchShelves().then((element) => console.log(element));
...
const fetchShelves = async () => {
  try {
    ...
    $(
      ...
      shelves.push(element); // Push the entire 'element' object, not just 'title'
    });
...
fetchShelves()
  .then((shelves) => {
    console.log(shelves); // Log the entire 'shelves' array
